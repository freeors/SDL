...
TTF_Font* TTF_OpenFontIndexRW( SDL_RWops *src, int freesrc, int ptsize, long index )
{
	...
	posix_print("TTF_OpenFontIndexRW(%i.%li), 1, used ticks: %u\n", ptsize, index, SDL_GetTicks() - start_ticks);
	...
	posix_print("TTF_OpenFontIndexRW(%i.%li), 2, used ticks: %u\n", ptsize, index, SDL_GetTicks() - start_ticks);
	start_ticks = SDL_GetTicks();
	...
	posix_print("TTF_OpenFontIndexRW(%i.%li), 3, used ticks: %u\n", ptsize, index, SDL_GetTicks() - start_ticks);
	start_ticks = SDL_GetTicks();
