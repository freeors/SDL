                    ...
                    int data2)
{
	...
	if ((windowevent == SDL_WINDOWEVENT_MINIMIZED || windowevent == SDL_WINDOWEVENT_MAXIMIZED || windowevent == SDL_WINDOWEVENT_RESTORED) && sdl_apphandlers.window_event_handler) {
		sdl_apphandlers.window_event_handler(windowevent, sdl_apphandlers.window_event_param);
		return 1;
	}
