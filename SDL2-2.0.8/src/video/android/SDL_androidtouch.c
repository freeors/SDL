...
void Android_OnTouch(int touch_device_id_in, int pointer_finger_id_in, int action, float x, float y, float p)
{
	...
	SDL_Log("Android_OnTouch, separate_mouse_and_touch: %s, touch_device_id_in: %i, pointer_finger_id_in: %i, action: %i, (%f, %f), p: %f", separate_mouse_and_touch? "true": "false", touch_device_id_in, pointer_finger_id_in, action, x, y, p);
