...
Android_VideoInit(_THIS)
{
	...
	SDL_Log("Android_VideoInit, E, (%ix%i)", Android_ScreenWidth, Android_ScreenHeight);
	...
	SDL_Log("Android_VideoInit, SDL_AddDisplayMode(...)");
    SDL_AddDisplayMode(&_this->displays[0], &mode);

	SDL_Log("Android_VideoInit, Android_InitKeyboard(), (%ix%i)", mode.w, mode.h);
    Android_InitKeyboard();

	SDL_Log("Android_VideoInit, Android_InitTouch()");
    Android_InitTouch();

	SDL_Log("Android_VideoInit, Android_InitMouse()");
    Android_InitMouse();

	SDL_Log("Android_VideoInit, X");
...
{
	static int times = 0;
	SDL_Log("#%i, Android_SetScreenResolution------(%ix%i), format: 0x%08x, rate: %7.2f, Android_Window: %p", 
