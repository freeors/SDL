...
SDL_DYNAPI_PROC(SDL_bool, SDL_IsRootPath, (const char* a), (a), return)
SDL_DYNAPI_PROC(SDL_bool, SDL_IsFromRootPath, (const char* a), (a), return)
SDL_DYNAPI_PROC(SDL_bool, SDL_IsDirectory, (const char *a), (a), return)
SDL_DYNAPI_PROC(SDL_bool, SDL_IsFile, (const char *a), (a), return)
SDL_DYNAPI_PROC(SDL_DIR*, SDL_OpenDir, (const char* a), (a), return)
SDL_DYNAPI_PROC(SDL_dirent2*, SDL_ReadDir, (SDL_DIR* a), (a), return)
SDL_DYNAPI_PROC(int, SDL_CloseDir, (SDL_DIR* a), (a), return)
SDL_DYNAPI_PROC(SDL_bool, SDL_GetStat, (const char* a, SDL_dirent* b), (a, b), return)
SDL_DYNAPI_PROC(SDL_Photo*, SDL_OpenPhoto, (const char* a), (a), return)
SDL_DYNAPI_PROC(void*, SDL_ReadPhoto, (SDL_Photo* a, const int b, const int c, const int d), (a,b,c,d), return)
SDL_DYNAPI_PROC(int, SDL_ClosePhoto, (SDL_Photo* a), (a), return)
SDL_DYNAPI_PROC(SDL_bool, SDL_MakeDirectory, (const char* a), (a), return)
SDL_DYNAPI_PROC(SDL_bool, SDL_DeleteFiles, (const char* a), (a), return)
SDL_DYNAPI_PROC(SDL_bool, SDL_CopyFiles, (const char* a, const char* b), (a, b), return)
SDL_DYNAPI_PROC(SDL_bool, SDL_RenameFile, (const char* a, const char* b), (a, b), return)
SDL_DYNAPI_PROC(int64_t, SDL_DiskFreeSpace, (const char* a), (a), return)
SDL_DYNAPI_PROC(void, SDL_GetPlatformVariable, (void** a, void** b, void** c), (a, b, c), )
SDL_DYNAPI_PROC(char*, SDL_CreateGUID, (SDL_bool a), (a), return)
...
SDL_DYNAPI_PROC(int, SDL_GetDpiScale, (void), (), return)
SDL_DYNAPI_PROC(int, SDL_GetStatusBarHeight, (void), (), return)
SDL_DYNAPI_PROC(void, SDL_ShowStatusBar, (SDL_bool a), (a),)
SDL_DYNAPI_PROC(void, SDL_EnableStatusBar, (SDL_bool a), (a),)
SDL_DYNAPI_PROC(void, SDL_SetStatusBarColor, (SDL_bool a), (a),)
SDL_DYNAPI_PROC(void, SDL_TurnOnScreen, (SDL_bool a), (a),)
SDL_DYNAPI_PROC(void, SDL_Reboot, (void),(),)
SDL_DYNAPI_PROC(void, SDL_SetAppType, (int a), (a), )
SDL_DYNAPI_PROC(void, SDL_SetNonblockPump, (SDL_bool a), (a),)
SDL_DYNAPI_PROC(void, SDL_SetAppHandlers, (SDL_AppHandlers *a), (a),)
...
SDL_DYNAPI_PROC(int, SDL_IsAppInstalled, (int a), (a), return)
SDL_DYNAPI_PROC(int, SDL_ThirdLogin, (int a, SDL_LoginCallback b, const char* c, const char* d, void* e), (a, b, c, d, e), return)
SDL_DYNAPI_PROC(int, SDL_ThirdSend, (int a, int b, int c, const uint8_t* d, const int e, const char* f, const char* g, const char* h, const uint8_t* i, const int j, SDL_SendCallback k, void* l), (a, b, c, d, e, f, g, h, i, j, k, l), return)
SDL_DYNAPI_PROC(SDL_bool, SDL_ReadCard, (SDL_IDCardInfo* a), (a), return)
SDL_DYNAPI_PROC(SDL_handle, SDL_OpenSerialPort, (const char* a, int b), (a, b), return)
SDL_DYNAPI_PROC(void, SDL_CloseSerialPort, (SDL_handle a), (a), )
SDL_DYNAPI_PROC(size_t, SDL_ReadSerialPort, (SDL_handle a, void* b, size_t c), (a, b, c), return)
SDL_DYNAPI_PROC(size_t, SDL_WriteSerialPort, (SDL_handle a, const void* b, size_t c), (a, b, c), return)
SDL_DYNAPI_PROC(void, SDL_Shutdown, (void), (), )
SDL_DYNAPI_PROC(SDL_bool, SDL_SetTime, (int64_t a), (a), return)
SDL_DYNAPI_PROC(void, SDL_UpdateApp, (const char* a), (a), )
SDL_DYNAPI_PROC(void, SDL_GetIpConfiguration, (SDL_IpConfiguration* a), (a), )
SDL_DYNAPI_PROC(void, SDL_SetIpConfiguration, (const SDL_IpConfiguration* a), (a), )
SDL_DYNAPI_PROC(void, SDL_GetOsInfo, (SDL_OsInfo* a), (a), )
SDL_DYNAPI_PROC(SDL_bool, SDL_PrintText, (const uint8_t* a, int b), (a, b), return)
SDL_DYNAPI_PROC(void, SDL_EnableRelay, (SDL_bool a), (a),)
SDL_DYNAPI_PROC(void, SDL_TurnOnFlashlight, (SDL_LightColor a), (a),)
SDL_DYNAPI_PROC(SDL_BleService*, SDL_BleFindService, (SDL_BlePeripheral* a, const char* b), (a, b), return)
SDL_DYNAPI_PROC(SDL_BleCharacteristic*, SDL_BleFindCharacteristic, (SDL_BlePeripheral* a, const char* b, const char* c), (a, b, c), return)
SDL_DYNAPI_PROC(void, SDL_BleSetCallbacks, (SDL_BleCallbacks* a), (a), )
SDL_DYNAPI_PROC(void, SDL_BleScanPeripherals, (const char* a), (a), )
SDL_DYNAPI_PROC(void, SDL_BleStopScanPeripherals, (void), (), )
SDL_DYNAPI_PROC(void, SDL_BleReleasePeripheral, (SDL_BlePeripheral* a), (a), )
SDL_DYNAPI_PROC(void, SDL_BleStartAdvertise, (void), (), )
SDL_DYNAPI_PROC(void, SDL_BleConnectPeripheral, (SDL_BlePeripheral* a), (a), )
SDL_DYNAPI_PROC(void, SDL_BleDisconnectPeripheral, (SDL_BlePeripheral* a), (a), )
SDL_DYNAPI_PROC(void, SDL_BleGetServices, (SDL_BlePeripheral* a), (a), )
SDL_DYNAPI_PROC(void, SDL_BleGetCharacteristics, (SDL_BlePeripheral* a, SDL_BleService* b), (a, b), )
SDL_DYNAPI_PROC(void, SDL_BleReadCharacteristic, (SDL_BlePeripheral* a, SDL_BleCharacteristic* b), (a, b), )
SDL_DYNAPI_PROC(void, SDL_BleWriteCharacteristic, (SDL_BlePeripheral* a, SDL_BleCharacteristic* b, const uint8_t* c, int d), (a, b, c, d), )
SDL_DYNAPI_PROC(void, SDL_BleNotifyCharacteristic, (SDL_BlePeripheral* a, SDL_BleCharacteristic* b, SDL_bool c), (a, b, c), )
SDL_DYNAPI_PROC(void, SDL_BleDiscoverDescriptors, (SDL_BlePeripheral* a, SDL_BleCharacteristic* b), (a, b), )
SDL_DYNAPI_PROC(int, SDL_BleAuthorizationStatus, (void), (), return)
SDL_DYNAPI_PROC(SDL_bool, SDL_BleUuidEqual, (const char* a, const char* b), (a, b), return)